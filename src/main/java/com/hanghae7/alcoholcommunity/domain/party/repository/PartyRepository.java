...
public interface PartyRepository extends JpaRepository<Party, Long> {
	...
	@Query("select p from Party p where p.placeName like %:keyword% or p.stationName like %:keyword% or p.placeAddress like %:keyword% and p.isDeleted = false ORDER BY p.partyDate desc")
