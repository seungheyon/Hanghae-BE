...
PROJECT_ROOT="/home/ubuntu/soolo-serv" # 프로젝트 루트
JAR_FILE="$PROJECT_ROOT/build/libs/alcoholcommunity-0.0.1-SNAPSHOT.jar" # JAR_FILE (어쩌구저쩌구.jar)
...
nohup java -jar -Dserver.port=${TARGET_PORT} ${JAR_FILE} > /home/ubuntu/build/libs/nohup.out 2>&1 &
